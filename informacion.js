let data = [
    {
        ...
        article2: {
            titulo: "Elige la talla de ropa IDEAL para tus hijos",
            header: "Lo primero que debes diferenciar y entender, es que las tallas para bebé y para niños, son distintas.  Las tallas entre 0 y 3 años son para bebés y es medida por meses , las tallas infantiles son de 3 a 7 años.",
            div: "Tallas para Bebe Niña",
